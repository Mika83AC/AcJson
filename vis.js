...
function buildHierarchy(csv) {
  	...
  	root.children.push({"name": "I1", "children": [{"name": "I2", "children": [], "size": 10}, {"name": "I3", "children": [], "size": 10}]});
...
function startVis(evt) {
	...
	if (file) {
		...
		r.onload = function(e) { 
  			...
  			var hierarchyJSON = buildHierarchy(dataSource);

  			createVisualization(hierarchyJSON);
		}
		r.readAsText(file);
	} else { 
