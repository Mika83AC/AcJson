...
const IndividualFactory = function IndividualFactory(options) {
...
const FamilyFactory = function FamilyFactory(options) {
    return Object.assign(Object.create(IndividualProto), options);
};
const ChildProto = {
    id: '',
...
const ChildFactory = function ChildFactory(options) {
...
const EventFactory = function EventFactory(options) {
...
const MediaFactory = function MediaFactory(options) {
    return Object.assign(Object.create(MediaProto), options);
};
// Converter functions ////////////////////////////////////////////////////////////////////////////////////////////
const GEDCOMtoACJSON = function (gedcomData) {
    ...
    let events = [];
    let children = [];
    let individual = IndividualFactory();
    let family = FamilyFactory();
...
const ACJSONtoGEDCOM = function (acJSONObj) {
    let lb = "\r\n";
...
const getFamily = function (acJSONObj, familyId) {
...
const countOfCharInStr = function countOfCharInStr(str, searchChar) {
    let count = 0;
